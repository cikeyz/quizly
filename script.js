...
function renderAdminDashboard() {
  ...
  // Version 02: stat cards use the double-bezel shell/core architecture
  statsRow.innerHTML = `
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${totalQuizzes}</div><div class="stat-label">Quizzes</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${totalSubmissions}</div><div class="stat-label">Submissions</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${avgScore}</div><div class="stat-label">Avg Score</div></div></div>
  `;
    ...
    resultsEl.innerHTML = myResults.map(sub => {
      ...
      return `
        <div class="list-item">
          ...
          <div class="list-item-actions">
            <span style="font-family:var(--font-display);font-size:18px;font-weight:700;color:var(--accent);">${sub.score}/${sub.totalQuestions}</span>
          </div>
        </div>
      `;
    }).join('');
...
function renderResults() {
  ...
  // Version 02: result stats use the double-bezel shell/core pattern
  statsEl.innerHTML = `
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${submission.totalQuestions}</div><div class="stat-label">Total</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${errors}</div><div class="stat-label">Errors</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${pct}%</div><div class="stat-label">Accuracy</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${submission.score}</div><div class="stat-label">Correct</div></div></div>
  `;
...
function viewStats(quizId) {
  ...
  // Version 02: stats summary uses double-bezel shell/core pattern
  summaryEl.innerHTML = `
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${subs.length}</div><div class="stat-label">Submissions</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${avg}</div><div class="stat-label">Average</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${best}</div><div class="stat-label">Highest</div></div></div>
    <div class="stat-card-shell"><div class="stat-card"><div class="stat-value">${worst}</div><div class="stat-label">Lowest</div></div></div>
  `;
